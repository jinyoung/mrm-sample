...
pluralCaseList.push( {plural: "standards", pascal: "Standard"} )

pluralCaseList.push( {plural: "productions", pascal: "Production"} )
pluralCaseList.push( {plural: "prodStandards", pascal: "ProdStandard"} )

pluralCaseList.push( {plural: "packings", pascal: "Packing"} )
